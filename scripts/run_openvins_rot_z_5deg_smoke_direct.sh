...
RUN_ID="openvins_MH01_rot_z_5deg_000"
...
LOG_PATH="$HOME/robotics_ws/camera-imu-calibration-sensitivity/results/logs/perturbed/${RUN_ID}/openvins_rot_z_5deg_smoke.log"
...
printf "\n=== Terminal 2: OpenVINS rotation_z_5deg smoke node ===\n"
printf "Run ID: %s\n" "$RUN_ID"
printf "Config: %s\n" "$CONFIG_PATH"
printf "Trajectory dir: %s\n" "$TRAJ_DIR"
printf "Log: %s\n\n" "$LOG_PATH"
printf "Leave this running. After Terminal 3 finishes, press Ctrl+C once here.\n\n"
